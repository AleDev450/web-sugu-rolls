...
const MODULOS: { clave: Clave; titulo: string; ruta: string; bajada: string }[] = [
  ...
  { clave: 'mod_paquetes', titulo: 'Promociones', ruta: '/promociones', bajada: 'Combos para compartir.' },
  { clave: 'mod_catering', titulo: 'Catering', ruta: '/catering', bajada: 'Servicio para eventos y su formulario.' },
  { clave: 'mod_promociones', titulo: 'Sugu Games', ruta: '/sugu-games', bajada: 'El juego y sus premios.' },
